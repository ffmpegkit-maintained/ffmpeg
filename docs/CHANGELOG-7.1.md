...
FFmpeg `n7.1.5` + two CVE backports. NDK **r27c** (`27.2.12479018`).
...
- **CVE-2026-64830** (vobsub) and **CVE-2026-64835** (adx), backported to `n7.1.5`.
...
Before publishing: **18 capability lists** compared against 7.1.6 for the two tiers that
...
All 12 coordinates carry one number: `check-versions.py 7.1` reports
`one number, 7.1.7, everywhere it is published`.
