...
**Status:** Free tier published on Maven Central as `dev.ffmpegkit-maintained:ffmpeg-kit-free-81:8.1.2`. Paid tiers (Basic/Full/Full GPL) built and available on [Jokobee](https://www.jokobee.com/ffmpegkit).
